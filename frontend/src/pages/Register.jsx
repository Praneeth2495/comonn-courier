...
function PasswordToggle({ shown, onToggle }) {
  return (
    <button
      ...
      style={{ position: 'absolute', right: 10, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--slate-light)', padding: 4, display: 'flex' }}
    >
