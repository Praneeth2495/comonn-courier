    ...
    <div>
      ...
      {loading ? <LoadingLogo /> : (
        <div className="table-wrap">
          ...
          {displayOrders.map((o) => (
            <div className={`t-row orders-detailed ${tab === 'bookings' ? 'with-actions' : ''} ${tab === 'pickup' ? 'with-driver' : ''} ${o.manualPaymentMarkedAt ? 'manual-paid' : o.__overdue ? 'overdue' : o.status === 'PICKED_UP' ? 'picked-up' : ''}`} key={o.id}>
              {tab === 'pickup' && (
                <div>
