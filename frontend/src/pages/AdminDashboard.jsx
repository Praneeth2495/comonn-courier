...
function UsersPanel() {
  ...
  return (
    <div>
      ...
      <div className="table-wrap">
        <table className="data-table">
          <thead><tr><th>Name</th><th>Email</th><th>Mobile</th><th>Joined</th><th>Role</th><th>Rider region</th><th>Delivery zones</th><th>Pickup states/regions</th><th>Overview access</th></tr></thead>
          <tbody>
            {users.map((u) => (
              <tr key={u.id}>
                <td>{u.fullName}</td>
